...
const COMPARISONS = [
  ...
  [
    ...
    "CoCounsel Core at $225/user/mo",
    "Litigator at $249/mo",
  ],
  [
    "Small civil rights firm",
    "Westlaw + CoCounsel at $428+/seat",
    "Firm at $199 base plus usage",
  ],
];
  ...
  return (
    <CommandSurface>
      ...
      <CommandMain className="space-y-10">
        <CommandHero
          eyebrow="Pricing"
          title="One system. No confusing agent marketplace."
          description="Start free, upgrade when you need court-ready drafts, contradiction detection, precedent search, or firm-level volume."
          icon={Scale}
        />
